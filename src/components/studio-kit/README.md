...
That keeps future updates practical: upstream changes can be reviewed component by component, while `/studio` stays a thin consumer of stable local primitives.
