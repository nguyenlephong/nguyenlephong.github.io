...
const reactFlowViews: StudioFlowArchitectureViewSpec[] = [
  ...
  },
  {
    ...
    nodes: [
      platformGroupNode("layer-client", "source", "Client platform", "Public and internal entry surfaces.", { x: -940, y: -300 }, { width: 260, height: 650 }),
      platformGroupNode("layer-edge", "review", "Edge platform", "Delivery, identity, policy, and routing boundary.", { x: -635, y: -300 }, { width: 300, height: 650 }),
      platformGroupNode("layer-services", "process", "Service platform", "Domain services plus async execution.", { x: -290, y: -300 }, { width: 490, height: 650 }),
      platformGroupNode("layer-data", "storage", "Data platform", "Transactional, cache, and analytical models.", { x: 255, y: -300 }, { width: 360, height: 650 }),
      platformGroupNode("layer-ops", "risk", "Operations platform", "Telemetry, audit, and release controls.", { x: 665, y: -300 }, { width: 290, height: 650 }),
      platformGroupNode("layer-external", "external", "External boundary", "Provider APIs and user-visible outputs.", { x: 1005, y: -300 }, { width: 270, height: 650 }),
