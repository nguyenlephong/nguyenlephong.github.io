...
export const chineseStudioCopy: StudioUiCopy = {
  brand: "Studio",
  navLabel: "个人 Studio",
  navItems: {
    welcome: "Welcome",
  ...
  runtime: {
    loading: "正在加载 Studio 工作区…",
    loadErrorTitle: "工作区不可用",
    loadErrorDetail: "无法加载此工作区。导航和偏好设置仍然可用。",
    reload: "重新加载 Studio"
  },
  dashboard: {
    workstreamCount: (count) => `${count} 个工作流`,
    emptyTitle: "没有匹配的工作流",
    emptyDescription: "请调整搜索词或状态筛选条件以查看工作流。",
    clearFilters: "清除筛选"
  },
  status: {
    ready: "就绪",
  ...
  routes: {
    ...
    "ai-agent-setup": {
      title: "AI Agent 设置",
      description:
        "用于 AI agent 工具、MCP 路径和安全机器初始化的个人设置笔记。",
    ...
    "ai-skills": {
      title: "AI 技能",
      description:
        "可复制的 markdown 技能，用于代码评审、架构、内容、提示词、报告、规格和提案。",
    ...
    "delivery-checklists": {
      title: "交付清单",
      description: "从任务接收到模块工作、发布准备和上线的操作清单。",
