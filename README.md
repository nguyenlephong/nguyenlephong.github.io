<h1 align="center"><a href="https://nguyenlephong.github.io/dom-profile">Portfolio</a></h1>

![Lines of code](https://img.shields.io/tokei/lines/github/nguyenlephong/dom-profile?style=flat-square) ![GitHub last commit](https://img.shields.io/github/last-commit/nguyenlephong/dom-profile?style=flat-square&logo=github) ![LGTM Grade](https://img.shields.io/lgtm/grade/javascript/github/nguyenlephong/dom-profile?logo=LGTM&style=flat-square) ![GitHub top language](https://img.shields.io/github/languages/top/nguyenlephong/dom-profile?logo=javascript&logoColor=white&style=flat-square) [![Build Status](https://travis-ci.com/nguyenlephong/dom-profile.svg?branch=main)](https://travis-ci.com/nguyenlephong/dom-profile) 
---
...
[![Version npm](https://img.shields.io/npm/v/url-parse.svg?style=flat-square)](https://www.npmjs.com/package/url-parse)
...
[![Coverage Status](https://img.shields.io/coveralls/unshiftio/url-parse/master.svg?style=flat-square)](https://coveralls.io/r/unshiftio/url-parse?branch=master)
...
1. **_NodeJS_**: _version: v10.16.0_, Link: [NodeJS](https://nodejs.org/en/download/)
2. **_Yarn_**: version: 1.16.0, Link: [Yarn](https://yarnpkg.com/lang/en/docs/install/#windows-stable)
3. **_WebStorm_**: version: 2020.0.3, Link: [Webstorm](https://www.jetbrains.com/webstorm/)
4. **_Google Chrome_**: a lasted version, Link: [GoogleChrome](https://www.google.com/intl/vi_vn/chrome/)
5. **_React_**: 17.0.1, Link: [ReactJS](https://reactjs.org/docs/getting-started.html)
6. **_Ant Design_**: 4.9.4, Link: [AntDesign](https://ant.design/docs/react/introduce)
