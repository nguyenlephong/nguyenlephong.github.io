console.log("%cENVIRONMENT: %s", "color: green; font-size: 32px; font-weight: bold", process.env.NEXT_PUBLIC_ENV);
const globalApp = {
  app: {
    VERSION: "v1.0.0",
  ...
  api: {
    ...
    BASE_URL: process.env.NEXT_PUBLIC_HOST_API_META_ROUTER || "http://localhost:8080/api",
  },
  firebaseConfig: {
  ...
  feature: {
    ...
    IS_SHOW_VERSION: process.env.NEXT_PUBLIC_IS_SHOW_VERSION === "true",
    IS_SHOW_MULTIPLE_LANGUAGE: process.env.NEXT_PUBLIC_IS_SHOW_MULTIPLE_LANGUAGE === "true"
  }
}
