...
const seo = {
  ...
  og: {
    title: "Nguyễn Lê Phong | Dom's Profile",
    type: "website",
    url: "https://nguyenlephong.github.io/dom-profile",
  },
};
...
const greeting = {
  ...
  portfolio_repository: "https://github.com/nguyenlephong/dom-profile",
};
  ...
  sections: [
    {
      ...
      experiences: [
        ...
        },
        {
          ...
          logo_path: configs.app.CDN_PATH + "/images/propman_logo.gif",
