...
test('archive routes and explorers keep pagination crawlable and search progressive', async () => {
  const [
    ...
    readFile('src/app/[locale]/blog/page/[page]/page.tsx', 'utf8'),
    readFile('src/app/[locale]/notes/page/[page]/page.tsx', 'utf8'),
    ...
    readFile('src/app/[locale]/search/blog.json/route.ts', 'utf8'),
    readFile('src/app/[locale]/search/notes.json/route.ts', 'utf8'),
